...
import { getPreApprovals, getCommonSpace, getIssueData, getPaymentData, getQRcode, getApiPreApprovals } from "../controllers/Resident.js";
...
residentRouter.get('/api/preApprovals', auth, authorizeR, getApiPreApprovals);
