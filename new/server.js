...
// Add these routes to your existing routes file (e.g., routes/auth.js or app.js)
...
} from "./controllers/OTP.js"; // Update path accordingly

// POST /forgot-password - Check email and send OTP
...
app.post('/verify-otp', async (req, res) => {
  try {
    ...
    // Verify OTP
    const verificationResult = verifyForgotPasswordOTP(email, otp);
    ...
    await resetPasswordAndSendEmail(email, emailCheck.userType);
...
app.get("/logout", (req, res) => {
  ...
  // Redirect to login instead of sending JSON
  res.redirect("/login");
});
